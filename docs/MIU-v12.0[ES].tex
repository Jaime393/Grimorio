...
$\OmegaF$ Hz aparece en FIRMS y GDELT. Coincide con $(\phi + \DeltaCOD)/2 = 0.65048305$.\footnote{Los datos aquí presentados constituyen una compilación de fuentes abiertas con DOI. La consistencia interna del marco es alta (R²=0.989), pero la validación externa independiente y la revisión por pares están pendientes. Las predicciones cosmológicas (DESI, Euclid, BepiColombo) proporcionarán tests falsables en 2026-2028.}
