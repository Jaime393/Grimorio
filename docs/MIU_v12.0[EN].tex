...
$\OmegaF$ Hz appears in FIRMS and GDELT spectra. Coincides with $(\phi + \DeltaCOD)/2 = 0.65048305$.\footnote{The data presented here constitute a compilation of open sources with DOI. Internal consistency of the framework is high (R²=0.989), but independent external validation and peer review are pending. The cosmological predictions (DESI, Euclid, BepiColombo) will provide falsifiable tests in 2026-2028.}
